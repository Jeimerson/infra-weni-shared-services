...
AWS_ACCOUNT_ID_MASTER=242357350604

GOOGLE_AUTH_IMAGE=dnxsolutions/aws-google-auth:latest
AZURE_AUTH_IMAGE=dnxsolutions/docker-aws-azure-ad:1.0.0
AWS_IMAGE=dnxsolutions/aws:2.1.6-dnx1
TERRAFORM_IMAGE=dnxsolutions/terraform:1.4.6-dnx1
...
RUN_TERRAFORM  =docker run  --rm --env-file=.env.auth --env-file=.env -v $(PWD):/work $(TERRAFORM_IMAGE)
